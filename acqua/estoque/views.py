...
from .forms import EstoqueItensSaidaForm, EstoqueItensEntradaForm, EstoqueForm
from .models import EstoqueEntrada, EstoqueItens, EstoqueSaida, Estoque
...
def dar_baixa_estoque(form):
    # Pega os produtos a partor da instacia do formulario(estoque)
