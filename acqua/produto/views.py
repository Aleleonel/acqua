...
# from acqua.produto.actions.import_xlsx import import_xlsx as action_import_xlsx
# from acqua.produto.actions.export_xlsx import export_xlsx
...
def import_csv_with_pandas(request):
    ...
    for row in df.values:
        ...
        aux.append(obj)
        Produto.objects.bulk_create(aux)
        messages.sucess(request, 'Produtos importados com sucesso.')
        return HttpResponseRedirect(reverse('produto:produto_list'))